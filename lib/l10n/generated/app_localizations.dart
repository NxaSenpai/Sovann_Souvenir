...
abstract class AppLocalizations {
  ...
  /// No description provided for @trackYourGifts.
  ///
  /// In en, this message translates to:
  /// **'Track your gifts'**
  String get trackYourGifts;
  ...
  /// No description provided for @fetchingOrders.
  ///
  /// In en, this message translates to:
  /// **'Fetching your orders…'**
  String get fetchingOrders;

  /// No description provided for @giftWrapIncluded.
  ///
  /// In en, this message translates to:
  /// **'Gift wrap included'**
  String get giftWrapIncluded;
  ...
  /// No description provided for @giftWrapAddAtCheckout.
  ///
  /// In en, this message translates to:
  /// **'Add at checkout'**
  String get giftWrapAddAtCheckout;
  ...
  /// No description provided for @chooseDeliveryDateOptional.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @shipped_.
  ///
  /// In en, this message translates to:
  /// **'Shipped'**
  String get shipped_;

  /// No description provided for @delivered_.
  ///
  /// In en, this message translates to:
  /// **'Delivered'**
  String get delivered_;
